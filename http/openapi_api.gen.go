...
type ServerInterface interface {
	...
	// update task
	// (PUT /tasks/{id})
	PutTask(ctx echo.Context, id openapi_types.UUID) error
}
...
// PutTask converts echo context to params.
func (w *ServerInterfaceWrapper) PutTask(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "id" -------------
	var id openapi_types.UUID
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.PUT(baseURL+"/tasks/:id", wrapper.PutTask)
